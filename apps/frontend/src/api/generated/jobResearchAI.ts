 ...
 */
export const aiControllerGetModelListV1 = (options?: AxiosRequestConfig): Promise<AxiosResponse<AiSecuredPresetsResponse>> => {
...
export const jobsControllerGetJobByIdV1 = (
  params: JobsControllerGetJobByIdV1Params,
  options?: AxiosRequestConfig,
...
export const jobsControllerGetJobsV1 = (
  params: JobsControllerGetJobsV1Params,
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<JobPaginationResponse>> => {
  return axios.get(`/v1/jobs/chunk`, {
    ...options,
    params: { ...params, ...options?.params },
  });
};
 ...
 * @summary Filters
 */
export const jobsControllerGetJobsFilterV1 = (options?: AxiosRequestConfig): Promise<AxiosResponse<JobFilterDtoResponse>> => {
  return axios.get(`/v1/jobs/filters`, options);
};

/**
 * Provides all available plans to buy
 * @summary Billing plans
 */
export const billingControllerGetPlansV1 = (options?: AxiosRequestConfig): Promise<AxiosResponse<PlansResponse>> => {
  return axios.get(`/v1/billing/plans`, options);
};
 ...
 */
export const billingControllerGetBundlesV1 = (options?: AxiosRequestConfig): Promise<AxiosResponse<BundlesResponse>> => {
  return axios.get(`/v1/billing/bundles`, options);
};
 ...
 */
export const billingControllerGetSubscriptionV1 = (options?: AxiosRequestConfig): Promise<AxiosResponse<SubscriptionModelResponse>> => {
  return axios.get(`/v1/billing/subscription`, options);
};

/**
 * Provides url for payment to subscribe the plan
 * @summary Provides url for payment to subscribe the plan
 */
export const billingControllerMakePaymentSubscriptionV1 = (
  createSubscriptionDto: CreateSubscriptionDto,
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<PaymentLinkResponse>> => {
  return axios.post(`/v1/billing/subscribe`, createSubscriptionDto, options);
};

/**
 * Provides url for payment to buy a bundle
 * @summary Provides url for payment to buy a bundle
 */
export const billingControllerMakeOnetimePaymentSubscriptionV1 = (
  buyBundleDto: BuyBundleDto,
  options?: AxiosRequestConfig,
): Promise<AxiosResponse<PaymentLinkResponse>> => {
  return axios.post(`/v1/billing/buy-bundle`, buyBundleDto, options);
};
...
export type BillingControllerGetPlansV1Result = AxiosResponse<PlansResponse>;
export type BillingControllerGetBundlesV1Result = AxiosResponse<BundlesResponse>;
export type BillingControllerGetSubscriptionV1Result = AxiosResponse<SubscriptionModelResponse>;
export type BillingControllerMakePaymentSubscriptionV1Result = AxiosResponse<PaymentLinkResponse>;
export type BillingControllerMakeOnetimePaymentSubscriptionV1Result = AxiosResponse<PaymentLinkResponse>;
