 ...
 */
export const billingControllerGetPlansV1 = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<PlansResponse>> => {
    return axios.get(
      `/v1/billing/plans`,options
    );
  }
 ...
 */
export const billingControllerGetBundlesV1 = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<BundlesResponse>> => {
    return axios.get(
      `/v1/billing/bundles`,options
    );
  }
 ...
 */
export const billingControllerGetSubscriptionV1 = (
     options?: AxiosRequestConfig
 ): Promise<AxiosResponse<SubscriptionModelResponse>> => {
    return axios.get(
      `/v1/billing/subscription`,options
    );
  }
...
export const billingControllerMakePaymentSubscriptionV1 = (
    createSubscriptionDto: CreateSubscriptionDto, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<PaymentLinkResponse>> => {
    return axios.post(
      `/v1/billing/subscribe`,
      createSubscriptionDto,options
    );
  }
...
export const billingControllerMakeOnetimePaymentSubscriptionV1 = (
    buyBundleDto: BuyBundleDto, options?: AxiosRequestConfig
 ): Promise<AxiosResponse<PaymentLinkResponse>> => {
    return axios.post(
      `/v1/billing/buy-bundle`,
      buyBundleDto,options
    );
  }
