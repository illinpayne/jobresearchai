  ...
  },
  {
    ...
    specifications: [
      ...
      { key: "Focus", value: "Accessibility and Inclusive Design" },
      {
        key: "Case Study",
        value:
          "Increased mobile conversion rates by 22% via user flow overhaul",
      },
    ],
  },
  {
    ...
    specifications: [
      ...
      { key: "Skills", value: "SQL, Tableau, Financial Modeling" },
      {
        key: "Observation",
        value:
          "Solid technical skills but lacks industry-specific storytelling",
      },
    ],
  },
];
  ...
  },
  {
    ...
    specifications: [
      { key: "Status", value: "AI Optimized / Final Version" },
      {
        key: "Improvement",
        value:
          "Integrated STAR method; highlighted Node.js and React efficiency gains",
      },
