...
export const redisEnv = registerAs<RedisConfig>('redis', () => {
	...
	return {
		host: process.env.NOTIFICATION_REDIS_HOST as string,
		port: parseInt(process.env.NOTIFICATION_REDIS_PORT as string, 10),
		user: process.env.NOTIFICATION_REDIS_USER as string,
		password: process.env.NOTIFICATION_REDIS_PASSWORD as string,
